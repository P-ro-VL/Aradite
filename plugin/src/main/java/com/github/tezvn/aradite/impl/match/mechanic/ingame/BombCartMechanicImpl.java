...
public class BombCartMechanicImpl extends AbstractMechanic {
    ...
    public BombCartMechanicImpl(Match match) {
        super(match);
    }
    ...
    public void onFinish() {
        ...
        team.getAllPlayers().forEach(player -> {
            ...
            player.sendTitle(lang.getString("mechanic." + getID() + ".finish." + path + ".title"),
    ...
    private class BombCartMechanicTask extends AsyncTimerTask {
        ...
        public BombCartMechanicTask(BombCartMechanicImpl mechanic) {
            ...
            Future<ExplosiveMinecart> explosiveMinecartFuture = Bukkit.getScheduler().callSyncMethod(AraditeImpl.getInstance(), () -> {
        ...
        private void handleNearbyPlayer(Location lookForwardLocation) {
             ...
             */
            List<Player> surroundPlayers = LocationUtils.getNearbyPlayers(this.minecart.getLocation(), PUSH_MINECART_RANGE);
        ...
        private void handleStop(Location goal) {
            ...
            Player defuser = LocationUtils.getNearbyPlayers(this.minecart.getLocation(), PUSH_MINECART_RANGE)
