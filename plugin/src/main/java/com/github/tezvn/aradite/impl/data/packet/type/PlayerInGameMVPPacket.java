...
public class PlayerInGameMVPPacket implements Packet<String> {
    ...
    public static enum MVPStatistics {
        ...
        public String getMedalIcon() {
            return  AraditeImpl.getInstance().getLanguage().getString("medal." + toString().toLowerCase() + ".icon");
        }
        ...
        public String getDescription(){
            return  AraditeImpl.getInstance().getLanguage().getString("medal." + toString().toLowerCase()
                    + ".description");
        }
    }
