package com.github.tezvn.aradite.impl.world;
 ...
 */
public class DefaultMatchMap implements MatchMap {

    private final Map<MatchLocationType, List<Location>> locationMap = Maps.newHashMap();

    public DefaultMatchMap(MapType mapType) {
        this.map = mapType;
    }
